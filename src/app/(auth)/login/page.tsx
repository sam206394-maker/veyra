  ...
  return (
    <div className="animate-fade-in-soft">
      ...
      <div className="mb-6 min-h-[220px]">
        {tab === "email" && <EmailAuth mode="login" onError={setError} />}
        {tab === "phone" && <PhoneAuth mode="login" onError={setError} />}
        {tab === "google" && <GoogleButton mode="login" onError={setError} />}
      </div>

      <div className="divider-label my-6">or continue with</div>
